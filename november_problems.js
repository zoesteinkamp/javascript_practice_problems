...
//So lets check to see if theres a triple amount of numbers in the first number.
// then see if theres a double in the second one
// then finally see if those numbers are the same
